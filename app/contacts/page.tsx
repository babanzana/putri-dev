    ...
    <Shell active="contacts" requiresAuth>
      <div className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-sm text-slate-500">Kontak supplier & channel</p>
        ...
        <div className="rounded-2xl border border-slate-100 bg-white/90 p-4 shadow-sm ring-1 ring-black/5">
          <p className="text-sm font-semibold text-slate-900">Channel komunikasi</p>
          <p className="text-xs text-slate-600">
            Email: support@sparx.id | WA: 0812-1234-5678 | IG: @sparxparts | FB: fb.com/sparxparts
          </p>
        </div>
      </div>
    </Shell>

...
const categories = [
  ...
  },
  {
    ...
    items: [
      "Metode: transfer bank (BCA/BNI/Mandiri)",
          ...
          <div className="relative grid gap-4 px-5 py-5 sm:grid-cols-[1.2fr,0.8fr] sm:items-center">
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                Temukan jawaban seputar katalog, keranjang, pembayaran, riwayat pembelian,
                pengaturan akun, dan informasi toko Ponti Pratama.
              </p>

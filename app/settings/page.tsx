        ...
        <div className="grid gap-4 lg:grid-cols-[1.2fr,1fr]">
          <div className="space-y-3 rounded-2xl bg-white/90 p-5 shadow-sm ring-1 ring-black/5">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Penyedia sparepart motor dan aksesoris dengan jaringan supplier nasional. Fokus pada
              kecepatan pengiriman, stok terkelola, dan dukungan pelanggan yang responsif.
            </p>
            ...
            <div className="rounded-xl bg-slate-50 px-3 py-3 text-xs text-slate-600">
              Informasi ini hanya tampilan profil. Pengaturan sensitif seperti password tidak dapat
              diubah di sini.
            </div>
          </div>
            ...
            <div className="mt-3 space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">Tagline toko bisa diletakkan di sini.</p>
                </div>
              </div>
